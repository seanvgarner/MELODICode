...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function () {
	  ...
	  var timeCellArr = [];
	  for (var i = 0; i < 16; i++) {
	    var timeBarCell = document.createElement("div");
	    var $timeBarCell = $(timeBarCell);
	  ...
	  var mappedColumns = grid.rows[0].map(function (col, i) {
	  ...
	  var loop = new _Tone2.default.Sequence(function (time, col) {
	    ...
	    for (var _i = 0; _i < 16; _i++) {
	      ...
	      if (column[_i].active) {
	        column[_i].parentContainer.addClass("hit");
	        column[_i].playNote();
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _note_constants = __webpack_require__(3);
	
	var _note_constants2 = _interopRequireDefault(_note_constants);
	...
	var Grid = function () {
	  function Grid(parentContainer, synth) {
	    ...
	    value: function createGrid() {
	      for (var i = 0; i < 16; i++) {
	        ...
	        for (var j = 0; j < 16; j++) {
	          ...
	          var cell = new _cell2.default($cellContainer, _note_constants2.default[i], this.synth);
...
/***/ function(module, exports) {
	...
	var noteConstants = ["A2", "C3", "D3", "E3", "G3", "A3", "C4", "D4", "E4", "G4", "A4", "C5", "D5", "E5", "G5", "A6"].reverse();
	
	exports.default = noteConstants;
	
	// A3 C4 D4 E4 G4 A4 C5 D5
...
/***/ function(module, exports) {
	...
	var Cell = function () {
	  function Cell(parentContainer, note, synth) {
